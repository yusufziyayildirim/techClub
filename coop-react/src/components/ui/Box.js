...
const Box = ({ src, count, title }) => {
    ...
    return (
        <div className='bg-[#0d0d0f] bg-opacity-90 py-12 rounded-xl flex items-center justify-center -skew-y-6 hover:-skew-y-0 ease-out duration-500 group shadow-lg shadow-[#0d0d0f]'>
